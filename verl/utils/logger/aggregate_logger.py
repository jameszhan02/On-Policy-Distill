...
_METRIC_DESCRIPTIONS = {
    ...
    "response/eos_generated_ratio": "fraction that stopped by generating a terminal token",
    "response/eos_teacher_coverage": "terminal tokens receiving finite teacher OPD signal",
...
_DEBUG_METRICS = (
    ...
    ("response/missing_final_answer_ratio", "missing final answer"),
    ("response/eos_generated_ratio", "EOS generated"),
    ("response/eos_teacher_coverage", "EOS teacher coverage"),
...
_DEBUG_PERCENT_METRICS = {
    ...
    "response/missing_final_answer_ratio",
    "response/eos_generated_ratio",
    "response/eos_teacher_coverage",
